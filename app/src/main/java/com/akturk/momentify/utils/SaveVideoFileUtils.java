//package com.akturk.momentify.utils;
//
...
//            dstFileInfo.mDirectory = new File(Environment.getExternalStorageDirectory(), BucketNames.DOWNLOAD);
...
//    }
//
//    private static void querySource(ContentResolver contentResolver, Uri uri, String[] projection, ContentResolverQueryCallback callback) {
//        Cursor cursor = null;
//        try {
...
//        querySource(contentResolver, uri, projection, new ContentResolverQueryCallback() {
//            @Override
//            public void onCursorResult(Cursor cursor) {
