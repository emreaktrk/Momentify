...
//        mTrimStartScrubber = BitmapFactory.decodeResource(getResources(), R.drawable.text_select_handle_left);
//        mTrimEndScrubber = BitmapFactory.decodeResource(getResources(), R.drawable.text_select_handle_right);
        mTrimStartScrubber = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher);
        mTrimEndScrubber = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher);
